# PdfPixel.Wpf.DirectXExperiments
...
A Direct3D 12 context wrapper (originally from PdfPixel.Console.Demo) that creates and manages DirectX 12 resources for SkiaSharp GPU backend. This demonstrates the D3D12 approach used in the console demo.
...
2. Set PdfPixel.Wpf.DirectXExperiments as the startup project
