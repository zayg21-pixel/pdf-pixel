...
{
    internal static class PdfPanelPageExtensions
    {
        internal static int GetTotalRotation(this PdfPanelPage page)
        {
            return page.Info.GetTotalRotation(page.UserRotation);
        }

        internal static SKSize GetRotatedSize(this PdfPanelPage page)
        {
            return page.Info.GetRotatedSize(page.UserRotation);
        }

        internal static SKRect GetBounds(this PdfPanelPage page)
        {
            SKSize rotatedSize = page.GetRotatedSize();
            return SKRect.Create(page.Offset, rotatedSize);
        }

        internal static SKRect GetScaledBounds(this PdfPanelPage page, float scale)
        {
            SKSize rotatedSize = page.GetRotatedSize();
