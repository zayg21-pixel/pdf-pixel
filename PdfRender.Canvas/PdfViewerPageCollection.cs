...
public sealed class PdfViewerPageCollection : ReadOnlyCollection<PdfViewerPage>, IDisposable
{
    ...
    internal PdfViewerPageCollection(PdfRenderer renderer, IList<PdfViewerPage> pages)
        : base(pages)
    {
        Renderer = renderer;
    ...
    internal PdfRenderer Renderer { get; }
    ...
    /// <returns></returns>
    public bool TryGetPopup(int pageNumber, SKPoint point, out AnnotationPopup popup)
    {
