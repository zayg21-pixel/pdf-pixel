...
internal sealed class Jbig2HuffmanTable
{
    ...
    /// </summary>
    public List<Jbig2HuffmanEntry> Entries { get; } = new List<Jbig2HuffmanEntry>();
    ...
    public static Jbig2HuffmanTable Build(ReadOnlySpan<HuffmanLine> lines)
    {
        ...
        var indexed = new List<(HuffmanLine Line, int Index)>(lines.Length);
    ...
    internal readonly struct HuffmanLine
    {
        ...
        public HuffmanLine(int rangeLow, int rangeLength, int prefixLength, bool isOob = false, bool isLowerRange = false)
        {
            RangeLow = rangeLow;
