...
using static PdfPixel.Imaging.Jbig2.Decoding.Jbig2HuffmanTable;
...
internal static class Jbig2StandardHuffmanTables
{
    ...
    [
        new HuffmanLine(0, 4, 1),
        new HuffmanLine(16, 8, 2),
        new HuffmanLine(272, 16, 3),
        new HuffmanLine(65808, 32, 3),
    ]);
    ...
    [
        new HuffmanLine(0, 0, 1),
        new HuffmanLine(1, 0, 2),
        new HuffmanLine(2, 0, 3),
        new HuffmanLine(3, 3, 4),
        new HuffmanLine(11, 6, 5),
        new HuffmanLine(75, 32, 6),
        new HuffmanLine(0, 0, 6, isOob: true),
    ]);
    ...
    [
        new HuffmanLine(-256, 8, 8),
        new HuffmanLine(0, 0, 1),
        new HuffmanLine(1, 0, 2),
        new HuffmanLine(2, 0, 3),
        new HuffmanLine(3, 3, 4),
        new HuffmanLine(11, 6, 5),
        new HuffmanLine(-257, 32, 8, isLowerRange: true),
        new HuffmanLine(75, 32, 7),
        new HuffmanLine(0, 0, 6, isOob: true),
    ]);
    ...
    [
        ...
        new HuffmanLine(12, 6, 5),
        new HuffmanLine(76, 32, 5),
    ]);
    ...
    [
        new HuffmanLine(-255, 8, 7),
        new HuffmanLine(1, 0, 1),
        new HuffmanLine(2, 0, 2),
        new HuffmanLine(3, 0, 3),
        new HuffmanLine(4, 3, 4),
        new HuffmanLine(12, 6, 5),
        new HuffmanLine(-256, 32, 7, isLowerRange: true),
        new HuffmanLine(76, 32, 6),
    ]);
    ...
    [
        new HuffmanLine(-2048, 10, 5),
        new HuffmanLine(-1024, 9, 4),
        new HuffmanLine(-512, 8, 4),
        new HuffmanLine(-256, 7, 4),
        new HuffmanLine(-128, 6, 5),
        new HuffmanLine(-64, 5, 5),
        new HuffmanLine(-32, 5, 4),
        new HuffmanLine(0, 7, 2),
        new HuffmanLine(128, 7, 3),
        new HuffmanLine(256, 8, 3),
        new HuffmanLine(512, 9, 4),
        new HuffmanLine(1024, 10, 4),
        new HuffmanLine(-2049, 32, 6, isLowerRange: true),
        new HuffmanLine(2048, 32, 6),
    ]);
    ...
    [
        new HuffmanLine(-1024, 9, 4),
        new HuffmanLine(-512, 8, 3),
        new HuffmanLine(-256, 7, 4),
        new HuffmanLine(-128, 6, 5),
        new HuffmanLine(-64, 5, 5),
        new HuffmanLine(-32, 5, 4),
        new HuffmanLine(0, 5, 4),
        new HuffmanLine(32, 5, 5),
        new HuffmanLine(64, 6, 5),
        new HuffmanLine(128, 7, 4),
        new HuffmanLine(256, 8, 3),
        new HuffmanLine(512, 9, 3),
        new HuffmanLine(1024, 10, 3),
        new HuffmanLine(-1025, 32, 5, isLowerRange: true),
        new HuffmanLine(2048, 32, 5),
    ]);
    ...
    [
        new HuffmanLine(0, 1, 2),
        new HuffmanLine(0, 0, 2, isOob: true),
        new HuffmanLine(4, 4, 3),
        new HuffmanLine(-1, 0, 4),
        new HuffmanLine(22, 4, 4),
        new HuffmanLine(38, 5, 4),
        new HuffmanLine(2, 0, 5),
        new HuffmanLine(70, 6, 5),
        new HuffmanLine(134, 7, 5),
        new HuffmanLine(3, 0, 6),
        new HuffmanLine(20, 1, 6),
        new HuffmanLine(262, 7, 6),
        new HuffmanLine(646, 10, 6),
        new HuffmanLine(-2, 0, 7),
        new HuffmanLine(390, 8, 7),
        new HuffmanLine(-15, 3, 8),
        new HuffmanLine(-5, 1, 8),
        new HuffmanLine(-7, 1, 9),
        new HuffmanLine(-3, 0, 9),
        new HuffmanLine(-16, 32, 9, isLowerRange: true),
        new HuffmanLine(1670, 32, 9),
    ]);
    ...
    [
        new HuffmanLine(0, 0, 2, isOob: true),
        new HuffmanLine(-1, 1, 3),
        new HuffmanLine(1, 1, 3),
        new HuffmanLine(7, 5, 3),
        new HuffmanLine(-3, 1, 4),
        new HuffmanLine(43, 5, 4),
        new HuffmanLine(75, 6, 4),
        new HuffmanLine(3, 1, 5),
        new HuffmanLine(139, 7, 5),
        new HuffmanLine(267, 8, 5),
        new HuffmanLine(5, 1, 6),
        new HuffmanLine(39, 2, 6),
        new HuffmanLine(523, 8, 6),
        new HuffmanLine(1291, 11, 6),
        new HuffmanLine(-5, 1, 7),
        new HuffmanLine(779, 9, 7),
        new HuffmanLine(-31, 4, 8),
        new HuffmanLine(-11, 2, 8),
        new HuffmanLine(-15, 2, 9),
        new HuffmanLine(-7, 1, 9),
        new HuffmanLine(-32, 32, 9, isLowerRange: true),
        new HuffmanLine(3339, 32, 9),
    ]);
    ...
    [
        ...
        new HuffmanLine(6, 6, 2),
        new HuffmanLine(0, 0, 2, isOob: true),
        new HuffmanLine(-3, 0, 5),
        new HuffmanLine(2, 0, 5),
        new HuffmanLine(70, 5, 5),
        new HuffmanLine(3, 0, 6),
        new HuffmanLine(102, 5, 6),
        new HuffmanLine(134, 6, 6),
        new HuffmanLine(198, 7, 6),
        new HuffmanLine(326, 8, 6),
        new HuffmanLine(582, 9, 6),
        new HuffmanLine(1094, 10, 6),
        new HuffmanLine(-21, 4, 7),
        new HuffmanLine(-4, 0, 7),
        new HuffmanLine(4, 0, 7),
        new HuffmanLine(2118, 11, 7),
        new HuffmanLine(-5, 0, 8),
        new HuffmanLine(5, 0, 8),
        new HuffmanLine(-22, 32, 8, isLowerRange: true),
        new HuffmanLine(4166, 32, 8),
    ]);
    ...
    [
        ...
        new HuffmanLine(9, 2, 5),
        new HuffmanLine(13, 2, 6),
        new HuffmanLine(17, 2, 7),
        new HuffmanLine(21, 3, 7),
        new HuffmanLine(29, 4, 7),
        new HuffmanLine(45, 5, 7),
        new HuffmanLine(77, 6, 7),
        new HuffmanLine(141, 32, 7),
    ]);
    ...
    [
        ...
        new HuffmanLine(8, 1, 6),
        new HuffmanLine(10, 0, 7),
        new HuffmanLine(11, 1, 7),
        new HuffmanLine(13, 2, 7),
        new HuffmanLine(17, 3, 7),
        new HuffmanLine(25, 4, 7),
        new HuffmanLine(41, 5, 8),
        new HuffmanLine(73, 32, 8),
    ]);
    ...
    [
        new HuffmanLine(1, 0, 1),
        new HuffmanLine(2, 0, 3),
        new HuffmanLine(7, 3, 3),
        new HuffmanLine(3, 0, 4),
        new HuffmanLine(5, 1, 4),
        new HuffmanLine(4, 0, 5),
        new HuffmanLine(15, 1, 6),
        new HuffmanLine(17, 2, 6),
        new HuffmanLine(21, 3, 6),
        new HuffmanLine(29, 4, 6),
        new HuffmanLine(45, 5, 6),
        new HuffmanLine(77, 6, 7),
        new HuffmanLine(141, 32, 7),
    ]);
    ...
    [
        ...
        new HuffmanLine(-1, 0, 3),
        new HuffmanLine(1, 0, 3),
        new HuffmanLine(-2, 0, 4),
        new HuffmanLine(2, 0, 4),
        new HuffmanLine(-4, 1, 5),
        new HuffmanLine(3, 1, 5),
        new HuffmanLine(-8, 2, 6),
        new HuffmanLine(5, 2, 6),
        new HuffmanLine(-24, 4, 7),
        new HuffmanLine(9, 4, 7),
        new HuffmanLine(-25, 32, 7, isLowerRange: true),
        new HuffmanLine(25, 32, 7),
    ]);
