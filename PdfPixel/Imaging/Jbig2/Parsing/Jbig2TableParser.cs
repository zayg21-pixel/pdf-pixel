...
namespace PdfPixel.Imaging.Jbig2.Parsing;
...
internal sealed class Jbig2TableParser
{
    ...
    public Jbig2HuffmanTable Parse(ReadOnlySpan<byte> segmentData)
    {
        ...
        while (currentLow < highValue && offset < bitLength)
        {
            ...
            lines.Add(new HuffmanLine(currentLow, rangeLength, prefixLength));
        ...
        if (offset < bitLength)
        {
            ...
            lines.Add(new HuffmanLine(highValue, 32, finalPrefixLength));
        }
        ...
        if (offset < bitLength)
        {
            ...
            lines.Add(new HuffmanLine(lowValue - 1, 32, lowPrefixLength, isLowerRange: true));
        }
        ...
        if (hasOob && offset < bitLength)
        {
            ...
            lines.Add(new HuffmanLine(0, 0, oobPrefixLength, isOob: true));
        }
