...
internal sealed class ManagedMd5 : IDisposable
{
    ...
    /// <summary>
    /// 64-byte internal block buffer.
    /// </summary>
    private readonly byte[] _block = new byte[64];

    /// <summary>
    /// Reusable buffer for the sixteen 32-bit words decoded from each block.
    /// </summary>
    ...
    /// </summary>
    public static ManagedMd5 Create() => new();

    /// <summary>
    /// Initialises a new instance and resets state to the MD5 initial values.
    /// </summary>
    public ManagedMd5() => Reset();
