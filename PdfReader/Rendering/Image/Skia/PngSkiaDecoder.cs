...
namespace PdfReader.Rendering.Image.Skia
{
    public class PngSkiaDecoder
    {
        ...
        /// Compatibility conditions (experiment):
        /// - Single /Filter == FlateDecode.
        /// - /DecodeParms predictor in [10..15] (PNG filters).
        /// - No /Decode array and no masking (no /ImageMask, /Mask, not a soft mask).
        /// - Device Gray (1 component, bpc 1,2,4,8) or Device RGB (3 components, bpc 8).
        /// - Dimensions positive.
        /// We perform lightweight zlib header validation (CMF/FLG) and trust the trailer (Adler32) to avoid
        /// a full decompression pass. Skia decode of the constructed PNG acts as a correctness gate.
        /// </summary>
