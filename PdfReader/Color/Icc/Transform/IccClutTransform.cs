...
{
    internal sealed partial class IccClutTransform : IIccTransform, IRgbaSampler
    {
        ...
        public IccClutTransform(Vector4[] clut, int outChannels, int[] gridPointsPerDimension)
        {
            ...
            _scaleFactors = IccVectorUtilities.ToVector4WithZeroPadding(scaleValues);
            ...
            _dimensionEnabled = IccVectorUtilities.ToVector4WithZeroPadding(dimensionMask);
            ...
            _strideVector = IccVectorUtilities.ToVector4WithZeroPadding(strideValues);
        ...
        private static Vector4[] ConvertFloatArrayToVector4Array(float[] clut, int outChannels)
        {
            ...
            for (int i = 0; i < totalEntries; i++)
            {
                ...
                vector4Clut[i] = IccVectorUtilities.ToVector4WithOnePadding(channelSpan);
            }
        ...
        {
            var vector = IccVectorUtilities.ToVector4WithOnePadding(source);
        ...
        public SKColor SampleColor(ReadOnlySpan<float> source)
        {
            ...
            Transform(ref vector);
            vector *= 255f;
            return new SKColor((byte)vector.X, (byte)vector.Y, (byte)vector.Z);
        }
