...
{
    /// <summary>
    /// Frame type not yet determined (no SOF segment parsed).
    /// </summary>
    Unknown = 0,
    ...
    /// <summary>
    /// SOF1: Extended sequential DCT, Huffman coding. Supports 12-bit precision and multiple sequential scans.
    /// </summary>
