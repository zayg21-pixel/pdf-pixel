...
public static class PdfResourceLoader
{
    ...
    public static byte[] GetResource(string resourceName)
    {
        ...
        using Stream stream = assembly.GetManifestResourceStream($"PdfRender.Resources.{resourceName}");
    ...
    {
        var assembly = typeof(PdfTextResourceConverter).Assembly;
        using Stream compressedStream = assembly.GetManifestResourceStream($"PdfRender.Resources.{resourceName}");
