...
internal ref struct JpxBitWriter
{
    ...
    public JpxBitWriter(in Span<byte> destination) => _destination = destination;
    ...
    /// <summary>
    /// Flushes any remaining buffered bits to the destination. Must be called after the last write.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Flush()
    {
