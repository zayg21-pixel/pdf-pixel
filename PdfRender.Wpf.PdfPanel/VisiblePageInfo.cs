...
namespace PdfRender.Wpf.PdfPanel
{
    ...
    {
        public VisiblePageInfo(int pageNumber, Point offset, PageInfo pageInfo, int userRotation)
        {
        ...
        /// </summary>
        public Size RotatedSize => PageInfo.GetRotatedSize(UserRotation);

        /// <summary>
        /// Gets the unscaled bounds of the page.
        /// </summary>
        public Rect Bounds => new Rect(Offset, RotatedSize);
        ...
        /// <returns></returns>
        public Rect GetScaledBounds(double scale) => new Rect(Offset.X * scale, Offset.Y * scale, RotatedSize.Width * scale, RotatedSize.Height * scale);

        internal SKRect GetSkScaledBounds(double scale) => SKRect.Create((float)(Offset.X * scale), (float)(Offset.Y * scale), (float)(RotatedSize.Width * scale), (float)(RotatedSize.Height * scale));
        ...
        {
            Point scaledPosition = new Point(canvasPosition.X / scale, canvasPosition.Y / scale);
